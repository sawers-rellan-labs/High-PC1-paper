...
Interestingly, for yield related traits, the effect of the highland allele shows typical conditional neutrality with increased fitness of the \textit{ZmPLA1.2-PT} allele in highland environments. 
Conversely, the previously characterized \textit{mexicana} introgression textit{inv4m} \cite{Gonzalez-Segovia2019-jy} shows no effect in highland environments and negative effect in lowland environments \cite{Crow2020-gene}.
