...
We elucidate the evolutionary history of a novel, major metabolic QTL, that we mapped down to a single gene \textit{HPC1}, which  is the result of a highland teosinte mexicana introgression in maize, leads to high phosphatidylcholine levels, and improves fitness via induction of early flowering. 
