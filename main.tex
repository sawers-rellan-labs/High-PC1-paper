...
C)PCs, LPCs and PC/LPCs Z-score effect sizes of BILs at chr 3 8.5 Mb that are either homozygous B73 or PT (top row) and CRISPR-CAS9 \textit{ZmPLa1.2} mutant and wild plants (bottom row).        
...
A) PC/LPC ratios of BIL B042 that shows a recombination of event (indicated by a red triangle) 500 bp upstream of the ATG compared with the PC/LPC ratio of representative RIL that is B73 in that region.
C) \textit{ZmPla1.2} Expression analysis of B73, PT and their F1 grown in control and cold temperatures. 
D) Promoter and CDS nucleotide diversity analysis of \textit{ZmPla1.2} in highland and lowland landraces from México and South America. Data obtained from \cite{Wang2020-mp, Wang2017-bc}.
E) Bacterial optimal growth temperature of different residues at the position in the flap-lid domain where the B73/PT mutation leading to a p.Ile211Val conversion was identified. Across the whole lipase domain, residues in bold in the flap lid domain (A) showed high correlation with bacterial OGT. 
F) Alignments around the p.Ile211Val conversion in the flap-lid domain in B73, mexicana and parviglumis and highland and lowland landraces SWUS, mesoamerican highlands and lowlands and Andes and South America lowlands. 
} 
\label{Fig4}
\end{center}
\end{figure*} 
...
B) Gene expression correlation with several flowering traits in 5 tissues from the 282 panel. Data from \cite{Kremling2018-gn}. 
C) \textit{ZmPla1.2-PT} expression correlation with DTA in short and long days. Inbred lines from the PT lineage shown in Fig 5 are colored in blue while inbred lines from the B73 lineage are colored in red} 
\label{Fig6}
\end{center}
\end{figure}
