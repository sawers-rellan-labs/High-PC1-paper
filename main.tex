...
%We analyzed selection of glycerolipid-related pathways both at the gene and metabolite level in highland maize using several approaches. %Jeff: careful with wording because you're not comparing pathways but genes in a pathway
%Jeff: commented out as i'm not sure  this intro sentence is needed
...
%(p < 2.87e – 5, Figure \ref{SupFig1}A).  
...
\textit{ZmLPCAT1} is an example of a gene selected, with shared outlier SNPs in the CDS region, in all four populations that is part of the 'phospholipid remodelling' and 'PC acyl editing' pathways ((Figure \ref{Fig1}C), Supplementary File 1). %Jeff: awkward sentence. a rewrite for brevity/clarity? split into two?
...
Phosphorus content in flag leaves of the the same \textit{Zmpla1.2\textsuperscript{CR}} and WT mutants used for the flowering time experiment were analyzed using ICP-OES at the North Carolina Department of Agriculture.   %Jeff: this should be with crispr experiment, not here
