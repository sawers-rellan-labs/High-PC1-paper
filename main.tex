...
% Jeff: would remove "highland teosinte" from title for easier reading and broader interest. "Adaptive introgression at \textit{ZmPLA1.2} controls phosphatidylcholine levels and induces earlier flowering in maize."
...
In the highlands, maize was exposed to a range of novel environmental factors , including lower temperatures that impose a strong selection on flowering time.
% Here, we used several population genetic approaches to show that genes in pathways controlling the synthesis and degradation of phosphatidylcholine lead to high phosphatidylcholine/lysophosphatidylcholine (PC/LPC) ratios in Mexican highland maize. 
% Jeff: this doesn't make sense. you don't use popgen to show that you have high PC/LPC ratios in the highlands. you use popgen to show introgression or allele freq. change. or maybe you can say that you use popgen to show that selection on genes in X pathway lead to Y? 
Linkage mapping and genome scans identified a highland maize loss of function of \textit{ZmPLA1.2}, a gene encoding a phospholipase A1 enzyme as the major driver of high PC/LPC ratios. 
%Jeff: rewrite OK? Ruben: Ok, fine Jeff. (nobody else strongly objected.
We then showed that the highland \textit{ZmPLA1.2} allele was introgressed from teosinte \textit{mexicana} and that it has been conserved in maize from the Northern US and Europe. 
We showed that genetic variation in \textit{ZmPLA1.2} exhibits a strong genotype by environment interaction in common garden experiments and that the highland \textit{ZmPLA1.2} allele leads to higher fitness in highland environments possibly via a reduction of flowering time.
%We further confirmed the effects of \textit{ZmPLA1.2} in PC/LPC ratios and flowering time using a CRISPR-CAS9 mutant of \textit{ZmPLA1.2}.
...
\end{abstract}
%Jeff: abstract needs a concluding sentence wrapping it up. what's the takehome? Something like that?
...
%Jeff: one concern  -- not immediately clear how these relate to flowering time mentioned in abstract. maybe mention shorter growing season too?
...
%Jeff: "adaptation to soil" is an "adaptive trait" is odd phrasing. maybe "tolerance of soils with low phosphorous" or "ability to grow in soils with low phosphorous" but calling "adaptation" an "adaptive trait" is weird
...
%Jeff: seems out of place. why do i care about europe at this point in the paper? i'd drop and bring it up in the discussion?
...
In this paper we used several approaches to study the possible role of glycerolipid -- and in particular phospholipid -- metabolism in maize adaptation to highlands. %Jeff: mdash instead of commas?
...
%Jeff: wonder if worth discussing this below (maybe you do) but most flowering time loci don't show massive GxE so this is an interesting couterexample Ruben: Okay done 
...
%Jeff: what outgroup used is already in the Methods
...
%Jeff: check tense. We found (past) genes that are (present)? OK
...
%Jeff: more common to refer to them as continents but either way OK Ruben: OK Fine,  Continent it is :/
...
Two replicates of the HiLo Diversity panel accessions and three replicates of the B73 x PT BILs were planted in a field located in Metepec, Edo de México, (19\degree13'28.7"N 99\degree32'51.6"W) within the Trans-Mexican volcanic belt. 
...
%Jeff: personal style pref. end of above section and in next section you switch to passive voice. i much prefer the active voice used earlier
