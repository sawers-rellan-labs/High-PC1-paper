...
# Selected just Mexican accessions (SEEDs) genotype and Teosintes ( HAPMAP not georeferenced).
# Merging SEEDs data with HapMap required:
# Download data from hapmap 282 set in AGPV2 for ZmPLA1.2
# Merge with SEDDs data for ZmPLA1.2 that is in AGPv2
# Liftover to AGPV3
# Filter heterozygotes out
...
vcf_file <-  file.path('data','fig_2', 'zmpla12_merged_het0_AGPv3_phased.vcf')
...
h <- haplotype(majordna) # Here we get the sequences as haplotypes fro plotting
