...
% TODO(Fausto): Perform paired t-test analysis for data in panel F. We could perform this analysis using "paired" data between highland and lowland accessions. 
...
% TODO(Fausto): Add supplementary file containing all this information. OK to include in this file orphan and unnotated genes that were not assigned to any pathway. 
